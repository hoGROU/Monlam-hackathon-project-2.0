...
export default function Footer() {
  return (
    <footer className="border-t border-ink-200/70 bg-white dark:border-ink-800/70 dark:bg-ink-900/40">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 text-sm sm:flex sm:gap-16">
            <div>
              <p className="mb-3 text-xs font-semibold uppercase tracking-[0.12em] text-ink-400 dark:text-ink-500">
                Project
              </p>
